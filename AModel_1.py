...
callbacks = [ReduceLROnPlateau(monitor = 'val_loss', factor = 0.1,
             ...
             EarlyStopping(patience = 9, # Patience should be larger than the one in ReduceLROnPlateau
                          min_delta = 1e-5),
             CSVLogger(r"/content/drive/MyDrive/AModel_1/training.log", append = True),
             ModelCheckpoint(r'/content/drive/MyDrive/AModel_1/backup_last_model.hdf5'),
             ModelCheckpoint(r'/content/drive/MyDrive/AModel_1/best_val_acc.hdf5', monitor = 'val_accuracy', mode = 'max', save_best_only = True),
             ModelCheckpoint(r'/content/drive/MyDrive/AModel_1/best_val_loss.hdf5', monitor = 'val_loss', mode = 'min', save_best_only = True)]

model.fit(trainGenerator, epochs = 30, validation_data = validationGenerator, callbacks = callbacks)

model = load_model(r'/content/drive/MyDrive/AModel_1/best_val_loss.hdf5')
